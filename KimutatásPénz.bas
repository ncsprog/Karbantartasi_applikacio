Attribute VB_Name = "Kimutatás_pénzügyek"
Option Explicit
...
MsgBox "ez még fejlesztés alatt van"
'anyag ktsg igazítás, jelenleg top 10-es
Munka15.Range("a1").AutoFilter 14, 10, xlTop10Items
