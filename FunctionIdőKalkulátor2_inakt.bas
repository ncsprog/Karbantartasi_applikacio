Attribute VB_Name = "FunctionIdõKalkulátor2_inakt"
Option Explicit
...
T1koord = "j" & T1rw
Range(T1koord) = AppWindow.TextBox74
...
T2koord = "k" & T2rw
Range(T2koord) = AppWindow.TextBox49

'Csekkolás

Csek1 = Len(AppWindow.TextBox74)
Csek2 = Len(AppWindow.TextBox49)
...
T_tõl = Left(AppWindow.TextBox74, 2)
M_tõl = Right(AppWindow.TextBox74, 2)

'Ig-óra, perc

T_ig = Left(AppWindow.TextBox49, 2)
M_ig = Right(AppWindow.TextBox49, 2)
